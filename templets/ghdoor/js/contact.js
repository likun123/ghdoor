...
$(window).scroll(function(){
  ...
  if($(window).scrollTop()>($('.ab_sec1').offset().top-600)){  
	  $('.ab_sec1_con2>p').delay(0).animate({top:"0",opacity:"1"},1000);
      }
...
$(document).ready(function(){
	 $('.cont_r_a').click(function(){
	   $('#dituContent').delay(300).animate({opacity:"1"},600);
	   $('.gbdt').delay(300).animate({opacity:"1"},600);
	   $('.cont_r_a').delay(300).animate({opacity:"0"},600)
	  
	 })
	 
	 $('.gbdt').click(function(){
	   $('#dituContent').delay(300).animate({opacity:"0"},600);
	   $('.gbdt').delay(300).animate({opacity:"0"},600);
	   $('.cont_r_a').delay(300).animate({opacity:"1"},600)
